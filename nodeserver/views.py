...
def get_chain(request):
    ...
    content = {"length": len(chain_data), "chain": chain_data, "peers": list(peers)}
...
def announce_new_block(block):
    ...
    for peer in peers:
        ...
        try:
            ...
            response = requests.posts(url, data=json.dumps(block.__dict__, sort_keys=True), headers=headers)
